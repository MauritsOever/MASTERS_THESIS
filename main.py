...
def RE_analysis(datatypes, in_sample=True):
    ...
    for data_type in datatypes: #'normal', 't', 'mix', 'returns']:
        ...
        if data_type == 'returns':
            ...
            if in_sample:
                ...
                for sim_dim in range(len(simulated_dims)):
                    data = GetData(datatypes[0], simulated_dims[sim_dim], 0.5)
                    ...
                    for ass_dim in range(len(assumed_dims)):
                        ...
                        for i in range(10):
                            ...
                            modelgaus = VAE(xtrain, ass_dim, dist='normal')
                            modelt    = VAE(xtrain, ass_dim, dist='t')
